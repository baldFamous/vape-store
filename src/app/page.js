        ...
        <div className="min-h-screen flex flex-col font-montserrat bg-background text-on-background">
            <nav className="fixed top-0 w-full z-50 glass-nav flex justify-between items-center px-8 h-20 shadow-[0_24px_24px_-12px_rgba(223,183,255,0.06)]">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    <Link href="/" className="text-[#dfb7ff] transition-colors font-medium">Inicio</Link>
                    <Link href="/productos" className="text-[#cec3d2] hover:text-[#dfb7ff] transition-colors font-medium">Productos</Link>
            ...
            <main className="flex-grow pt-20">
                ...
                <section className="relative min-h-[921px] flex items-center overflow-hidden px-8 md:px-20">
                    ...
                    <div className="relative z-20 max-w-4xl">
                        ...
                        <Link href="/productos" className="inline-block px-12 py-5 bg-[#e1bee7] text-[#2d004d] font-bold uppercase tracking-widest hover:bg-[#f3e5f5] transition-all">
                            El Catálogo
                        </Link>
                    </div>
                </section>
                ...
                <section className="py-24 px-8 md:px-20 bg-background relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Hardware */}
                            <Link href="/productos" className="group relative aspect-square md:aspect-[3/4] overflow-hidden rounded-2xl glass-card hover:-translate-y-2 transition-transform duration-500">
                ...
                <section className="py-24 px-8 md:px-20 bg-background">
                    <div className="max-w-7xl mx-auto">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
                            ...
                            <Link href="/productos" className="text-primary border-b border-primary pb-1 text-sm font-bold uppercase tracking-widest hover:text-primary-fixed transition-colors">Ver Catálogo Completo</Link>
                        </div>
                        
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            {recommendedProducts.map(p => (
                                <Link href={`/productos`} key={p.id} className="group relative bg-surface-container-low rounded-xl overflow-hidden transition-all duration-500 hover:bg-surface-container hover:-translate-y-1 block">
                                    {p.new && (
